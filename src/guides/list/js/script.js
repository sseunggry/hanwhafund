/* ==============================
		IA 목록 Data Script - jQuery 기반 (관리자 연동 추가)
============================== */

// 데이터 파일 로드 확인용 (실제 로드는 HTML에서)
// console.log("Data files should be loaded before this script.");
