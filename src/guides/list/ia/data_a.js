const iaPageAData = {
	...
	list: [
		...
		{ createDate: "2025-11-10", modifyDate: "2025-12-22", category: "한화펀드", depth1: "펀드찾기", depth2: "-", depth3: "일자별 기준가", pageName: "기준가팝업", pageType: "popup", pageID: "FD_01_02_01P", link: "", isAdminLinked: false, status: "완료", memo: [{detail: `2025-12-24: 직접설정 버튼 tablet-mobile-only 클래스로 수정`}, {detail: `p 태그 수정`}], },
