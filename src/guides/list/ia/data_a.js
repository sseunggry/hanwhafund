const iaPageAData = {
	...
	list: [
		...
		// --- 한화펀드 ---
		{ createDate: "2025-11-21", modifyDate: "2025-12-22", category: "한화펀드", depth1: "펀드찾기", depth2: "-", depth3: "-", pageName: "펀드찾기", pageType: "page", pageID: "FD_01", link: "", isAdminLinked: true, status: "완료", memo: [{detail: `2025-12-22: 버튼명 '다시 선택' -> '설정 초기화' 수정`}, {detail: `2025-12-12: badge 컬러 light-orange 로 변경`}], },
		{ createDate: "2025-11-21", modifyDate: "2025-12-24", category: "한화펀드", depth1: "펀드찾기", depth2: "펀드 상품 비교", depth3: "-", pageName: "펀드비교팝업", pageType: "popup", pageID: "FD_01_01P", link: "", isAdminLinked: false, status: "완료", memo: [{detail: `2025-12-24: 직접설정 버튼 tablet-mobile-only 클래스로 수정`}, {detail: `2025-12-12: badge 컬러 light-orange 로 변경`}], },
		{ createDate: "2025-11-10", modifyDate: "2025-12-24", category: "한화펀드", depth1: "펀드찾기", depth2: "펀드 상세 ", depth3: "-", pageName: "펀드상품상세", pageType: "page", pageID: "FD_01_02", link: "", isAdminLinked: true, status: "완료", memo: [{detail: `2025-12-24: 꼭확인하세요 텍스트 수정, 직접설정 버튼 tablet-mobile-only 클래스로 수정 `}, {detail: `2025-12-23: 버튼태그 수정`}, {detail: `2025-12-22: 공유하기 팝업 수정, 보수및수수료 마크업 순서 변경`}, {detail: `2025-12-12: badge 컬러 light-orange 로 변경`}, {detail: `2025-12-04: th scope="row" -> td 태그로 변경`}, {detail: "2025-11-21: 위험수준 레벨 클래스 수정(개발 요청), 펀드리스트 뱃지 클래스 수정, desc 텍스트 추가"}], },
		...
		{ createDate: "2025-12-18", modifyDate: "2025-12-24", category: "한화펀드", depth1: "연금펀드", depth2: "퇴직연금", depth3: "-", pageName: "퇴직연금", pageType: "page", pageID: "FD_02_02", link: "", isAdminLinked: false, status: "완료", memo: [{detail: `테이블 th scope="row" -> td로 변경, note-list br 추가`}], },
		...
		{ createDate: "2025-12-18", modifyDate: "", category: "회사소개", depth1: "글로벌 네트워크", depth2: "-", depth3: "-", pageName: "글로벌네트워크", pageType: "page", pageID: "CP_03", link: "", isAdminLinked: true, status: "완료", memo: [], },
		...
		{ createDate: "2025-12-18", modifyDate: "", category: "회사소개", depth1: "운용시스템", depth2: "내부통제 점검체계", depth3: "-", pageName: "내부통제 점검체계", pageType: "tab", pageID: "CP_05_03T", link: "", isAdminLinked: false, status: "완료", memo: [], },
		...
		// --- Footer ---
		{ createDate: "2025-11-17", modifyDate: "2025-12-24", category: "Footer", depth1: "스튜어드십코드", depth2: "스튜어드십코드", depth3: "-", pageName: "스튜어드십코드", pageType: "tab", pageID: "FT_01_01T", link: "", isAdminLinked: true, status: "완료", memo: [{detail: `2025-12-24: 아코디언 active 클래스 제거`}, {detail: `2025-12-04: th scope="row" -> td 태그로 변경`}], },
		...
		{ createDate: "2025-11-17", modifyDate: "2025-12-24", category: "Footer", depth1: "윤리경영", depth2: "사이버신문고", depth3: "-", pageName: "사이버신문고", pageType: "tab", pageID: "FT_05_04T", link: "", isAdminLinked: false, status: "완료", memo: [{detail: '2025-12-24: 버튼 마크업 수정 및 팝업 마크업 추가'}, {detail: '2025-12-17: <p class="txt-appendix full"> 마크업 추가'}], },
