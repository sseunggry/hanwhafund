const iaPageAData = {
	...
	list: [
		...
		{ createDate: "2025-11-10", modifyDate: "2025-12-24", category: "한화펀드", depth1: "펀드찾기", depth2: "펀드 상세 ", depth3: "-", pageName: "펀드상품상세", pageType: "page", pageID: "FD_01_02", link: "", isAdminLinked: true, status: "완료", memo: [{detail: `2025-12-24: 꼭확인하세요 텍스트 수정`}, {detail: `2025-12-23: 버튼태그 수정`}, {detail: `2025-12-22: 공유하기 팝업 수정, 보수및수수료 마크업 순서 변경`}, {detail: `2025-12-12: badge 컬러 light-orange 로 변경`}, {detail: `2025-12-04: th scope="row" -> td 태그로 변경`}, {detail: "2025-11-21: 위험수준 레벨 클래스 수정(개발 요청), 펀드리스트 뱃지 클래스 수정, desc 텍스트 추가"}], },
